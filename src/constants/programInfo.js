...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its programs to prepare students for a career as a medical assistant. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "NIMAA focuses exclusively on its Medical Assistant Training program."
    },
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKNIM18A",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $6,760 for Tuition and Program Fees for NIMAA's Medical Assistant Training program."
