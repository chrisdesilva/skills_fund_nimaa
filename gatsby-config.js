module.exports = {
  siteMetadata: {
    ...
    headline: `Partner financing page for Skills Fund and NIMAA`,
    author: `@Skills_Fund`,
    siteLanguage: `en`,
    logo: `src/images/skillsFund_logo.png`,
    favicon: `src/images/Favicon-SF.png`,
    keywords: `vocational training loans, skills training, medical assistant loans, tuition loan, tuition financing, medical training, primary care, bootcamp, full-time, part-time, student financing, student loans, loans, cosigner, underwriting, credit, credit score`
  },
  plugins: [
